...
class DeviceMatrixTests(unittest.TestCase):
    def test_internal_snake_mapping(self):
        self.assertEqual(physical_index(0, 0, 8), 0)
        self.assertEqual(physical_index(7, 0, 8), 7)
        self.assertEqual(physical_index(0, 1, 8), 15)
        self.assertEqual(physical_index(7, 1, 8), 8)

    def test_horizontal_and_four_module_order(self):
        self.assertEqual(physical_index(8, 0, 16), 64)
        self.assertEqual(physical_index(15, 1, 16), 72)
        self.assertEqual(physical_index(0, 8, 16), 128)
