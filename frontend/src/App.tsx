...
export default function App() {
  ...
  const [basicColors, setBasicColors] = useState<BasicColors>({ text: "#F8FAFC", hour: "#F8FAFC", minute: "#7DF9FF" });
  ...
  useEffect(() => {
    ...
    const signature = `${basicDisplay}|${basicFrame.join("")}|${activeProject.brightness}|${activeProject.pin}|${activeProject.pixel_order}|${activeProject.matrix_layout}`;
